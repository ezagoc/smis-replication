...
\subsection{Attrition and Sample-Restriction Balance}
\label{app:attrition_balance}

This subsection reports balance checks for endline attrition outcomes and for the main sample restrictions used in the extensive, intensive, and ads specifications. The tables below use the same treatment definitions, fixed effects, batch splits, and inference approach as the corresponding main-regression families.

\input{../results/attrition/tables/attrition_extensive.tex}
\newpage

\input{../results/attrition/tables/attrition_intensive.tex}
\newpage

\input{../results/attrition/tables/attrition_ads.tex}
\newpage

\input{../results/attrition/tables/sample_restrictions_extensive.tex}
\newpage

\input{../results/attrition/tables/sample_restrictions_intensive.tex}
\newpage

\input{../results/attrition/tables/sample_restrictions_ads.tex}
\newpage
