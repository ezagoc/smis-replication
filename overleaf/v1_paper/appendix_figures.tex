...
\begin{figure}[!htbp]
    ...
    \includegraphics[width=\textwidth]{../results/replots/followers_extensive/followers_extensive_b1_1000perm.pdf}
...
\begin{figure}[!htbp]
    ...
    \includegraphics[width=\textwidth]{../results/replots/followers_extensive_strong/followers_extensive_strong_b1_1000perm.pdf}
...
\begin{figure}[!htbp]
    ...
    \includegraphics[width=\textwidth]{../results/replots/followers_intensive/followers_intensive_b1_1000perm.pdf}
...
\begin{figure}[!htbp]
    \centering
    \caption{Follower Outcomes: Stage-by-Stage Effects, Batch 1}
    \includegraphics[width=\textwidth]{../results/replots/followers_stages/followers_stages_b1_1000perm.pdf}
    \label{fig:appendix_followers_stages_b1}
    \floatfoot{\textit{Notes:} The figure reports the estimated effect of treatment on the follower outcomes for the Batch 1 stage-specific specifications. Both follower outcomes are shown in the same graph and whiskers denote permutation-based 95\% confidence intervals.}
\end{figure}
\newpage
...
\begin{figure}[!htbp]
    ...
    \includegraphics[width=\textwidth]{../results/replots/followers_aggregate/followers_aggregate_b1_1000perm.pdf}
