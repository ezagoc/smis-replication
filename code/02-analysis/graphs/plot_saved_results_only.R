...
standard_stage_panel_defs <- tribble(
  ...
  "total_reactions",   "panel_b",  "Panel B. Overall engagement",
  "total_comments",    "panel_b",  "Panel B. Overall engagement",
  "total_shares",      "panel_b",  "Panel B. Overall engagement",
  "n_posts",           "panel_a",  "Panel A. Posting and veracity behavior",
  "eng",               "panel_a",  "Panel A. Posting and veracity behavior",
  "verifiability",     "panel_a",  "Panel A. Posting and veracity behavior",
  "non_ver",           "panel_a",  "Panel A. Posting and veracity behavior",
  "true",              "panel_a",  "Panel A. Posting and veracity behavior",
  "fake",              "panel_a",  "Panel A. Posting and veracity behavior",
