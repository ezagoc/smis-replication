...
standard_panel_defs <- tribble(
  ...
  "total_reactions",   "Panel B.",  2L,          "Overall engagement",             1L,
  "total_comments",    "Panel B.",  2L,          "Overall engagement",             2L,
  "total_shares",      "Panel B.",  2L,          "Overall engagement",             3L,
  "n_posts",           "Panel A.",  1L,          "Posting and veracity behavior",  1L,
  "eng",               "Panel A.",  1L,          "Posting and veracity behavior",  2L,
  "verifiability",     "Panel A.",  1L,          "Posting and veracity behavior",  3L,
  "non_ver",           "Panel A.",  1L,          "Posting and veracity behavior",  4L,
  "true",              "Panel A.",  1L,          "Posting and veracity behavior",  5L,
  "fake",              "Panel A.",  1L,          "Posting and veracity behavior",  6L,
